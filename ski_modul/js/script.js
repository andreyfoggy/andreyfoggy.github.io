...
function myFunction() {
    if (document.body.scrollTop > 100 || document.documentElement.scrollTop > 100) {
        document.querySelector("nav").style.backgroundColor = "rgb(101, 205, 238)"
    }
    else{
       document.querySelector("nav").style.backgroundColor = "rgba(123, 181, 197,0.239)"
    }
} 
...
class PictureSlider extends HTMLElement {
    constructor () {
        ...
        this.btnRight.appendChild(imgRight)
        var imgLeft = document.createElement("img")
        imgLeft.src = "img/left.png"
        this.btnLeft.appendChild(imgLeft)
